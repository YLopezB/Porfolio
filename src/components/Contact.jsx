      ...
      <div className="container pt-20 lg:grid lg grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col reveal--x">
          ...
          <p className="text-zinc-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch]">
            ...
            soluta eligendi hic, quisquam perspiciatis commodi totam quo
            repellendus mollitia obcaecati quasi, accusantium ullam, laudantium
            molestias odio minus dolor animi?
          </p>
