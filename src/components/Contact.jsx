export default function Contact() {
  ...
  return (
    <section id="contact" className="section pb-20">
      <div className="container pt-20 lg:grid lg grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col reveal--x">
          <h2 className="headline-2 lg:max-w-[12ch]">Contactame</h2>
          <p className="text-zinc-400 mt-3 mb-8">
            ¿Tienes una oportunidad, proyecto o idea en mente?
            <br />
            Me interesa participar en proyectos que generen impacto, resolver
            desafíos técnicos y seguir creciendo como Software Engineer.
            Actualmente trabajo con tecnologías como Java, Spring Boot, React,
            Node.js y bases de datos SQL y NoSQL para construir aplicaciones web
            modernas y escalables.
            <br />
            Completa el formulario con tu correo electrónico y tu mensaje y yo
            revisaré tu consulta y me pondré en contacto contigo lo antes
            posible.
          </p>
        ...
        <form
          action="https://getform.io/f/ayveolyb"
          className="xl:pl-10 2xl:pl-20"
          method="POST"
        >
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2 reveal-x">
            <div className="mb-4">
          ...
          <button
            type="submit"
            className="btn btn-primary flex !max-w-none md:!max-w-max w-full justify-center reveal-x"
          >
            Enviar
          </button>
        </form>
